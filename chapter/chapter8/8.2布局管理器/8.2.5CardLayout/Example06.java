...
class Cardlayout extends Frame implements ActionListener {
	...
	public Cardlayout() {
		...
		cardPanel.add(new JLabel("第一个界面", JLabel.CENTER));
		cardPanel.add(new JLabel("第二个界面", JLabel.CENTER));
		cardPanel.add(new JLabel("第三个界面", JLabel.CENTER));
		// 创建两个按钮对象
