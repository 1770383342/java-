...
public class InsertStu extends JFrame {
	...
	public InsertStu() {
		...
		comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"计算机科学与技术学院", "文学院"}));
		...
		comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"计科1701班", "计科1702班", "计科1801班", "软工1801班", "软工1802班"}));
